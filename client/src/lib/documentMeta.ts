...
export function resetDocumentMeta() {
  setDocumentMeta({
    title: "Nourix Academy – تكوين رقمي",
    description:
      "Nourix Academy — منصة تكوين في الإعلام الآلي، البيروتيك، الذكاء الاصطناعي والتجارة الإلكترونية، بالعربية والفرنسية والإنجليزية: دروس عملية، كتب ومراجع حقيقية، وشهادات عند إتمام كل مستوى.",
  });
}
