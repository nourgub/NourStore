...
const labels = {
  ar: {
    ...
    level: {
      ...
      advanced: "B2 (متوسط متقدم)",
      exam: "C1 (تحضير الامتحان الدولي)",
      professional: "C2 (احترافي)",
    },
  },
  fr: {
    ...
    level: {
      starter: "A1 (débutant)",
      foundation: "A2 (élémentaire)",
      intermediate: "B1 (intermédiaire)",
      advanced: "B2 (intermédiaire avancé)",
      exam: "C1 (prépa. examen international)",
      professional: "C2 (avancé)",
    },
  },
  en: {
    ...
    level: {
      starter: "A1 (beginner)",
      foundation: "A2 (elementary)",
      intermediate: "B1 (intermediate)",
      advanced: "B2 (upper-intermediate)",
      exam: "C1 (international exam prep)",
      professional: "C2 (advanced)",
    },
  },
} as const;
